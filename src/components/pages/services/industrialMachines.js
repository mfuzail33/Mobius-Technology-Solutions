        ...
        <>
            <section style={{ marginTop: '40px', position: 'relative' }}>
                <div style={{ position: 'relative', textAlign: 'center' }}>
                    <h2 className="display-6">{t('IndustrialMachines')}</h2>
                        ...
                        <div className="col-lg-6 mb-4 mb-lg-0">
                            <div className="hero__content position-relative">
                                <h3 className="display-5 m-30px-b">
                                    {t('MachineryExpertise')}
                                </h3>
                                <p className="mb-5 fs-5">
                                    <ul>
                                        <li style={{ fontSize: '18px', textAlign: 'start' }}>
                                            <b>{t('TypesofMachines')}:</b> {t('TypesofMachinesDetails')}
                                        </li>
                                        <li style={{ fontSize: '18px', textAlign: 'start' }}>
                                            <b>{t('ProcessEfficiency')}:</b> {t('ProcessEfficiencyDetails')}
                                        </li>
                                    </ul>
                                </p>
                            </div>
