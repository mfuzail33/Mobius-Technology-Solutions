...
import img from "../../../assets/images/moreServices/10.jpg"
        ...
        <>
            <section style={{ marginTop: '40px', position: 'relative' }}>
                <div style={{ position: 'relative', textAlign: 'center' }}>
                    <h2 className="display-6 heading">{t('OilandGasFields')}</h2>
                        ...
                        <div className="col-lg-6 mb-4 mb-lg-0">
                            <div className="hero__content position-relative">
                                <h3 className="display-5 m-30px-b heading">
                                    {t('InstrumentationandMonitoring')}
                                </h3>
                                <p className="mb-5 fs-5">
                                    <ul>
                                        <li style={{ fontSize: '18px', textAlign: 'start' }} className="heading">
                                            <b>{t('GasAnalytics')}:</b> {t('GasAnalyticsDetails')}
                                        </li>
                                        <li style={{ fontSize: '18px', textAlign: 'start' }} className="heading">
                                            <b>{t('FlowandLevelSensors')}:</b> {t('FlowandLevelSensorsDetails')}
                                        </li>
                                    </ul>
                                </p>
                            </div>
...
export default OilAndGasFields;
